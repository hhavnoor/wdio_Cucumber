class AuthPage {
  ...
  get input_CreateAccountEmail() { return $("#email_create") }

  get btn_CreateAccount() {  return $("#SubmitCreate")}

  get radio_Gender() {  return $("#uniform-id_gender1")}
  ...
  get drpbx_Days() {  return $("#days")}

  get drpbx_Months() {  return $("#months")}

  get drpbx_Years() { return $("#years") }

  get checkbox_NewsLetter() {  return $("#newsletter")}

  get checkbox_UniformOption() { return $("#uniform-optin")}

  get input_address_FirstName() { return $("input#firstname")}

  get input_address_LastName() { return $("input#lastname")}

  get input_address_Company() { return $("input#company")}

  get input_address_Address1() { return $("input#address1")}

  get input_address_Address2() { return $("input#address2")}

  get input_address_City() {return $("input#city") }

  get drpbx_State() { return $("#id_state")}

  get input_PostalCode() { return $("#postcode") }

  get drpbx_Country() { return $("#id_country") }

  get txt_AdditionalInfo() {return $("#other")}

  get input_Phone() { return $("#phone")}

  get input_MobilePhone() { return $("#phone_mobile")}

  get input_AddressAlias() { return $("#alias")}
  ...
  get input_login_Email() {return $("#email")}

  get input_login_Password() { return $("#passwd") }

  get btn_SubmitLogin() { return $("#SubmitLogin")}
  ...
  createAccount = async (emailId, address) => {
    ...
    await this.input_address_City.setValue("Hartford");
